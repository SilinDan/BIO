      	...
      	<div class="mobile-input">
			...
			<div class="mobile-content" style="background: #fff; min-width:320px ;"> 
								...
								<div class="little-nav">
									...
									<span>	<a href="moblie-hadadmin-bio.php">我的账户 </a></span><span> ></span>
			...
			<div class="cnt_right" style="border-top: 2px solid #ccc;">
				<div class="split-line-div1" style="font-size: 30px;text-align: center;margin-top: 20px;margin-bottom: 20px;">
					...
					<span class="split-line-text1" ">我的账户</span>
				...
				<p>因为您没有留下手机号码，所以无法查到您的积分信息，请点击“<a class="right_a" href="moblie-hadadmin-motifyinfo-bio.php">编辑我的信息</a>”，添加您的手机号。</p>
				<p>温馨提示：柜台/官网以您的手机号码为绑定进行同步积分，欢迎进入<a class="right_a" href="">积分兑礼页面 ></a></p>
				<div class="all_button" > 
					<a href="moblie-hadadmin-changepwd-bio.php" class="right_button">	修改密码</a>
					<a href="moblie-hadadmin-motifyinfo-bio.php" class="right_button">	编辑我的信息</a>
				</div>
			</div>
