...
<head>
	...
	<link rel="stylesheet" href="css/style.css">
			...
			<link rel="stylesheet" type="text/css" href="css/mobile_brand_activity.css"/>
      ...
      <div class="mobile-header">
      	...
      	<div class="mobile-input">
			...
			<div class="mobile-content" style="background: #fff; min-width:320px ;"> 
								<div class="weiwei"></div>
								<div class="brand-main">
								<div class="little-nav">
									<a href="default.v.php">	 首页 </a><span> ></span>
									<span style="color: #535355;">碧欧泉绿活泉</span>
								</div>
										<div class="brand-box">
											...
											<div class="brand-img brand-img2">
												<a class="a1" href=""></a>
												<img src="images/activity2-1.jpg">
											</div>
