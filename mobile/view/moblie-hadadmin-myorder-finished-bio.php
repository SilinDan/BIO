                  ...
                  if($had!=0){
                    ...
                    echo '
                      <div class="moblie-hadadmin-myorder-bio-box">
                        <a href="moblie-hadadmin-myorder-bio.php"><div class="mhmbb-right">
                          未完成订单（';
                    echo $dai1;
                    echo '）
                        </div></a>
                        <a href="moblie-hadadmin-myorder-finished-bio.php"><div class="mhmbb-left">
                          已完成订单（';
                    echo $had;
                    echo '）
                        </div></a>
                        ...
                        for($i=0; $i < $order_all; $i++){ 
                          ...
                          if($sty=='已支付'||$o_sty=='已取消'){
                            ...
                            echo $o_num;
                            echo' </div>
                                    <div class="waiting-pay font-blue">';
                              if($sty=='待支付'){
                                  echo '订单';
                                  echo $o_sty;
                              }
                    ...
                    echo '<div class="moblie-hadadmin-bio-mytry-head1">
                          你还没有任何订单，<a href="default.v.php">立即开始购物</a>
                        </div>';
                  }
            }
         ?>
					...
					<div class="moblie-hadadmin-order-box">

            <div class="mobile-unfinished-order-box">
              <div class="mobile-unfinished-order-content">


                <div class="mobile-order-number">
                  <div class="mobile-order-h2">订单编号：</div>
                  <div class="order-number">PCBIOSO300000122576</div>
                  <div class="waiting-pay font-blue">等待付款</div>
                </div>
                
                <div class="mobile-order-date">
                  <div class="mobile-order-h2">下单日期：</div>
                  <div class="order-date font-grey">2018-10-19 10:23:53</div>
                </div>

                <div class="mobile-order-pic-content">
                  <div class="order-pic"><a href="#"><img src="./images/20011.png" style="width: 122px;height: 122px;"></a></div>
                </div>

                <div class="mobile-order-bottom ">
                  <div class="order-info">
                    <div class="order-info-left">共有2件商品，总价：<span class="order-price">￥1,935</span></div>
                    <div class="order-pay-rightNow">
                      <a href="#">立即支付</a>
                    </div>
                  </div>
                  ...
                  <div class="order-operation">
                    <a href="#">再次购买</a>
                    <a href="mobile_order-detial.html">查看详情</a>
                    <a href="#">取消订单</a>
                  </div>
                </div>
