...
<head>
	...
	<link rel="stylesheet" href="css/style.css">
			...
			<link rel="stylesheet" type="text/css" href="css/mobile-free-try.css"/>
      	...
      	<div class="mobile-input">
			...
			<div class="mobile-content" style="background: #fff; min-width:320px ;"> 
				<div class="little-nav">
					...
					<span style="color: #535355;">	 免费试用 </span>
				</div>
			...
			<div id="try_main">
				<div id="try_main1"> 
					...
					<div id="img2">
						...
						<a href="" id="try_img2_a2"></a>
						<a href="" id="try_img2_a3"></a>
						<a href="" id="try_img2_a4"></a>
						<img src="images/a1k.jpg">
					</div>
					<div id="img3">
						<a href="" id="try_img3_a1"></a>
						<a href="" id="try_img3_a2"></a>
						<a href="" id="try_img3_a3"></a>
						<a href="" id="try_img3_a4"></a>
						<img src="images/a2.jpg">
					</div>
					<div id="img4">
						<a href="" id="try_img4_a1"></a>
						<a href="" id="try_img4_a2"></a>
						<a href="" id="try_img4_a3"></a>
						<a href="" id="try_img4_a4"></a>
