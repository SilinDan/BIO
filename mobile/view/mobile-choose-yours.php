      ...
      <div class="mobile-header">
      	...
      	<div class="mobile-input-serach">
			...
			<div class="mobile-content" style="background: #fff; min-width:320px ;"> 
						<div class="mobile-choose-content">
							<div class="choose-title">
								<h1>选择您的护肤品</h1>
							</div>
							<img src="images/choose-background.jpg" class="choose-background" >
						</div>
						<div class="choose-concern">
								<a href="mobile-goods-fiflter.php?searchValue=护肤&searchJudge=second"><button type="button">脸部护理</button></a>
								<a href="mobile-goods-fiflter.php?searchValue=牛奶润肤&searchJudge=second"><button type="button">身体护理</button></a>
								<a href="mobile-goods-fiflter.php?searchValue=防晒&searchJudge=second"><button type="button">隔离防晒</button></a>
						</div>
