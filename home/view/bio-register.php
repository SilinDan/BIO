	...
	<div class="background">
		<div class="re_content">
            ...
            <div class="split-line-div">
				...
				<span class="split-line-text">注册成为会员</span>
				<span class="split-line"></span>
			</div>
								

            <div class="back-to-login">  <span>我是已注册用户，前往 <a href="">登录</a></span></div>  

             <div class="form">
             		        	  <span class="detail">*为必填项</span> 
             		        	<form action="../api/user.api.php?act=reg"  id="myform" method="post">
             		        		<input type="radio" name="sex" value="女士"  />女士
             	                    <input type="radio" name="sex" value="男士" checked="checked" />男士
             						<table>
             							<tr>
             								<td colspan="2">
             									<div class="tips_box">
             										<input class="input_"  id="user" placeholder="您的邮箱/手机*" type="text" name="user_phone" onblur="checkuser()"/><span id="tishi" class="ok"> </span>
             							...
             							<tr>
             								<td colspan="2">
             									<div class="tips_box">
             										<input class="input_" id="pwd1" placeholder="密码*" type="password" name="pwd" onblur="checkpwd1()" />
             							...
             							<tr>
             								<td colspan="2">
             									<div class="tips_box">
             										<input class="input_" id="pwd2" placeholder="确认密码*" type="password" name="pwd2" onblur="checkpwd2()" />
             							...
             							<tr>
             								<td colspan="2"> 
             									<div class="tips_box">
             										<input class="input_"  id="mrbb-name1" placeholder="您的手机*" type="text" name="" onblur="checkphone()"/><br/>
             							...
             							<tr>
             								...
             								<td>
									         <input class="input_end"  id="code" placeholder="请输入验证码*" type="text" name="code" onblur="checkcode()"/>
								         <div class="tips code"></div>
								           ...
								           <td>
								         <img src="../../public/checkcode/code.php" id="img_code" title="单击刷新验证码" style="cursor:pointer;" onclick="this.src='../../public/checkcode/code.php?id='+Math.random()"/>
			               ...
			               <input type="submit" name="" class="submit_regis" value="立即注册" onclick="return register()"  >
               			</div>
			...
			<div class="re_contentright">
					<div class="order-footer">
							<div class="order-footer-acount">
								<h2 class="smalltitle">选择官网购物理由:</h2>
