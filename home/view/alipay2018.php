...
<div id="main">
    <div id="tabhead" class="tab-head">
        ...
        <form name=alipayment action=../../public/alipay20171220-window/pagepay/pagepay.php method=post target="_blank">
...
：</dt>
                    ...
                    <dd id="btn-dd">
						...
						<a href="index.v.php" style="text-decoration: none;"><span class="note-help">返回主页 > </span></a>
                    </dd>
                </dl>
            </div>
		</form>
...
// 		sNow += String(vNow.getMilliseconds());
		var num = getUrlParam(url,'num');
		var price = getUrlParam(url,'price');
		document.getElementById("WIDout_trade_no").value =  num;
		document.getElementById("WIDsubject").value = "碧欧泉购买订单";
