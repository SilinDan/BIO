								...
								if($dai1!=0){
										...
										echo '）</a></td>
											...
											for($i=0; $i < $order_all; $i++){	
												...
												if($sty=='待支付'&&$oderstate=='待确认'){
														...
														echo $sty;
														echo '</td>
																<td width="100px" style="margin-top:20px"><input type="button" onclick="pay('; 
														echo "'$o_num'";
														echo ')" class="nowpay" value="立即支付" ><br>
																<a style="color:#535355;text-decoration:underline;" href="bio-orderdetail.php?num=';
														echo $o_num; 
														echo '">查看详情</a><br>
																<a href="#" style="color:#535355;text-decoration:underline;" onclick="buyAgain(';
														echo "'$o_num'";
														echo ')" href="">再次购买</a><br>
																<a href="#" style="color:#535355;text-decoration:underline;" onclick="orderKanso(';
														echo "'$o_num'";
														echo ')">取消订单</a></td>
															</tr>
														';
										...
										echo '
												<div class="content-orderNum">
													<table border="1" width="100%" height="40px" cellpadding="5px;" cellspacing="0">
														<tr>
															<td width="20%" class="td1"><a class="order-finished" href="user_imformation_myOrder.php">未完成订单（0）</a></td>
															<td width="20%" class="td2"><a class="order-finished" href="user_imformation_myOrder_finished.php">已完成订单（'; 
								echo $had;
								echo '）</a></td>
															<td width="80%" class="td3"><a class="order-integral" href="">查看积分订单></a></td>
														</tr>
													</table>
												</div>
							...
							echo '
									<div class="content-orderNum">
										<table border="1" width="100%" height="40px" cellpadding="5px;" cellspacing="0">
											<tr>
												<td width="20%" class="td1"><a class="order-finished" href="user_imformation_myOrder.php">未完成订单（0）</a></td>
												<td width="20%" class="td2"><a class="order-finished" href="user_imformation_myOrder_finished.php">已完成订单（0）</a></td>
												<td width="80%" class="td3"><a class="order-integral" href="">查看积分订单></a></td>
											</tr>
										</table>
									</div>
...
<script>
	...
	function pay($o_num){
		window.location.href='bio-shoppingcart_3.php?order='+$o_num;
		// alert('hi');
	}
</script>