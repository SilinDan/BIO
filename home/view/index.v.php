			     ...
			     $(document).ready(function(){
			          ...
			          $.ajax({
			            ...
			            success:function(data){
			              ...
			              // $("#goods_english").val(data[0].goods_english);
			              // $("#goods_price").val(data[0].goods_price);
			              // $("#goods_remain").val(data[0].goods_remain);
			              // $("#goods_size").val(data[0].goods_size);
			              // $("#goods_detail").text(data[0].goods_detail);
			              
		
			              var tab='<div class="index-single-box-top">明星单品</div> <div class="index-single-box-show">';
		
			               $.each(data,function(i){
				               		// alert('yyy'+i);
				               		tab+='<div class="index-single-botton"><div class="isb-introduce"> <a href="detail-bio.php?id='+data[i].goods_id+'" ><div class="isb-introduce-man"> '+data[i].goods_sex+' </div><img src="./images/goods/'+data[i].goods_img+'"><div class="isb-introduce-name">'+data[i].goods_name+'</div><div class="isb-introduce-star"><img src="./images/star-blue.png"><img src="./images/star-blue.png"><img src="./images/star-blue.png"><img src="./images/star-blue.png"><img src="./images/star-blue.png"></div></a></div>';
						            tab+='<div class="isb-price">¥'+data[i].goods_price+'</div>';
						            tab+='<div class="isb-buy"><center><input type="button" name="hurry-buy" onclick="getGoodsId('+data[i].goods_id+')" value="立即购买" class="isb-buy-name"></center></div> </div>';
...
<div class="index-bio-bai"></div>
	<div class="index-bio-img" > 
		<a href="giftBox.php"><div class="index-bio-img-link"></div></a>
		<a href="bio-brandnews.php"><div class="index-bio-img-link"></div></a>
		<a href="manindex.v.php"><div class="index-bio-img-link"></div></a>
	</div>
	
	
<div class="index-single-box">
	<div class="index-single-box-left">
		
	</div>
	<div class="index-single-box-right">
		
	</div>
	<div id="indexShow">
		<div class="index-single-box-top">
			明星单品
		</div>
		<div class="index-single-box-show">
			<div class="index-single-botton">
				<div class="isb-introduce">
				<a href="detail-bio.html">
					<div class="isb-introduce-man">男士</div>
				...
				<div class="isb-price">¥490</div>
				<div class="isb-buy">
					<center><input type="submit" name="hurry-buy" value="立即购买" class="isb-buy-name"></center>
				</div>
			</div>
			...
			<div class="index-single-botton">
				<div class="isb-introduce">
				<a href="detail-bio.html">
					<div class="isb-introduce-man">女士</div>
			...
			<div class="index-single-botton">
				...
				<a href="detail-bio.html">
					<div class="isb-introduce-man">女士</div>
					<img src="./images/index-single-box3.png">
					<div class="isb-introduce-name">
						「奇迹水」肌底精华露
					</div>
					<div class="isb-introduce-star">
...
<div class="suibian" style="height:1740px;">
<div class="main">
		<div class="content-nei">
			<div class="title_div">
				<span class="font_title">王牌系列</span>
			</div>

			<div class="trump_series">
				<a href="">
			...
			<div class="title_div">
				<span class="font_title">品牌故事</span>
			</div>

			<div class="brand_story">
					<a href=""><img src="./images/brand_store_1.jpg"></a>
			</div>

			<div class="title_div">
				<span class="font_title">选择您的护肤品</span>
			</div>

			<div class="choose_product">
					<a href=""><img src="./images/homepage_skincare_selector_pc.jpg"></a>

					<div class="position_div_one"><span class="font_whiteone">您在寻找</span></div>
					<div class="position_div_two"><span class="font_whitetwo">什么样的护肤品？</span></div>
					<a class="position_choice" href="searchGoodsList.php?searchValue=查看所有分类&searchJudge=all">开始选择></a>
			</div>
		</div>
	</div>
